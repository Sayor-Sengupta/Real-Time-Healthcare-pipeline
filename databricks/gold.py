...
# Paths
silver_path = "abfss://silver@healthcarestorage13.dfs.core.windows.net/patient_flow"
gold_dim_patient = "abfss://gold@healthcarestorage13.dfs.core.windows.net/gold_dim_patient"
gold_dim_department = "abfss://gold@healthcarestorage13.dfs.core.windows.net/gold_dim_department"
gold_fact = "abfss://gold@healthcarestorage13.dfs.core.windows.net/patient_flow"
